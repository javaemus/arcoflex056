...
/*TODO*///    public static FILE eepromlog = null;//fopen("eeprom.log", "wa");  //for debug purposes
...
/*TODO*///    if (eepromlog!=null) fprintf(eepromlog,"EEPROM write bit %d\n",bit);
...
/*TODO*///                    if (eepromlog!=null) fprintf(eepromlog,"EEPROM unlock\n");
    ...
    {
/*TODO*///    if (eepromlog!=null && serial_count!=0)
    /*TODO*///{
/*TODO*///            fprintf(eepromlog,"EEPROM reset, buffer = %s\n",serial_buffer);
/*TODO*///    }
    ...
    {
    //#if VERBOSE
/*TODO*///    if (eepromlog!=null) fprintf(eepromlog,"write bit %d\n",bit);
    //#endif
            latch = bit;
    }
    ...
    //#if VERBOSE
/*TODO*///    if (eepromlog!=null) fprintf(eepromlog,"read bit %d\n",res);
    //#endif
    ...
    {
    //#if VERBOSE
/*TODO*///    if (eepromlog!=null) fprintf(eepromlog,"set reset line %d\n",state);
    //#endif
            reset_line = state;
    ...
    {
    //#if VERBOSE
/*TODO*///    if (eepromlog!=null) fprintf(eepromlog,"set clock line %d\n",state);
    //#endif
