...
public class ui_text {
    ...
    public static String default_text[]
            = {
                (!arcadeflex056.settings.MESS) ? "MAME" : "MESS",	
		...
		"ALL CPUS",
                ...
                (!arcadeflex056.settings.MESS) ? "History not available" : "System Info not available",
		...
		/* known problems */
                (!arcadeflex056.settings.MESS) ? "There are known problems with this game:" : "There are known problems with this system",
		...
		(!arcadeflex056.settings.MESS) ? "THIS GAME DOESN'T WORK PROPERLY" : "THIS SYSTEM DOESN'T WORK PROPERLY",
	...
	//#endif
		...
		"Bookkeeping Info",
	//#ifndef MESS
		(!arcadeflex056.settings.MESS) ? "Input (this game)" : "Input (this machine)",
		(!arcadeflex056.settings.MESS) ? "Game Information" : "Machine Information",
		(!arcadeflex056.settings.MESS) ? "Game History" : "Machine Usage & History",
		(!arcadeflex056.settings.MESS) ? "Reset Game" : "Reset Machine",
		(!arcadeflex056.settings.MESS) ? "Return to Game" : "Return to Machine",
	//#else
		"Image Information",
		"File Manager",
		"Tape Control",
