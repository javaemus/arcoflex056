...
import static WIP.mame056.vidhrdw.dooyong.bluehawk_fg2scroll;
import static WIP.mame056.vidhrdw.dooyong.bluehawk_vh_screenrefresh;
import static WIP.mame056.vidhrdw.dooyong.dooyong_eof_callback;
import static WIP.mame056.vidhrdw.dooyong.gulfstrm_vh_screenrefresh;
import static WIP.mame056.vidhrdw.dooyong.lastday_bgscroll;
import static WIP.mame056.vidhrdw.dooyong.lastday_ctrl_w;
import static WIP.mame056.vidhrdw.dooyong.lastday_fgscroll;
import static WIP.mame056.vidhrdw.dooyong.lastday_txvideoram;
import static WIP.mame056.vidhrdw.dooyong.lastday_vh_screenrefresh;
import static WIP.mame056.vidhrdw.dooyong.pollux_ctrl_w;
import static WIP.mame056.vidhrdw.dooyong.pollux_vh_screenrefresh;
import static WIP.mame056.vidhrdw.dooyong.primella_ctrl_w;
import static WIP.mame056.vidhrdw.dooyong.primella_vh_screenrefresh;
import static WIP.mame056.vidhrdw.dooyong.rshark_ctrl_w;
import static WIP.mame056.vidhrdw.dooyong.rshark_eof_callback;
import static WIP.mame056.vidhrdw.dooyong.rshark_scroll1;
import static WIP.mame056.vidhrdw.dooyong.rshark_scroll2;
import static WIP.mame056.vidhrdw.dooyong.rshark_scroll3;
import static WIP.mame056.vidhrdw.dooyong.rshark_scroll4;
import static WIP.mame056.vidhrdw.dooyong.rshark_vh_screenrefresh;
import static mame056.common.flip_screen_set;
...
import static mame056.commonH.REGION_GFX5;
import static mame056.commonH.REGION_GFX6;
...
import static mame056.commonH.ROM_FILL;
import static mame056.commonH.ROM_LOAD;
import static mame056.commonH.ROM_LOAD16_BYTE;
import static mame056.commonH.ROM_LOAD16_WORD_SWAP;
...
import static mame056.cpuintrfH.CPU_M68000;
import static mame056.cpuintrfH.CPU_Z80;
import static mame056.drawgfxH.RGN_FRAC;
...
import static mame056.driverH.GAME_IMPERFECT_GRAPHICS;
import static mame056.driverH.ROT0;
import static mame056.driverH.ROT270;
import static mame056.driverH.VIDEO_BUFFERS_SPRITERAM;
import static mame056.driverH.VIDEO_TYPE_RASTER;
import static mame056.inptport.input_port_0_r;
import static mame056.inptport.input_port_0_word_r;
import static mame056.inptport.input_port_1_r;
import static mame056.inptport.input_port_1_word_r;
import static mame056.inptport.input_port_2_r;
import static mame056.inptport.input_port_2_word_r;
...
import static mame056.memoryH.cpu_setbank;
import static mame056.palette.paletteram;
import static mame056.palette.paletteram16_xRRRRRGGGGGBBBBB_word_w;
import static mame056.palette.paletteram_xRRRRRGGGGGBBBBB_w;
import static mame056.palette.paletteram_xxxxBBBBGGGGRRRR_w;
import static mame056.sndintrf.soundlatch_r;
import static mame056.sndintrf.soundlatch_w;
import static mame056.sndintrf.soundlatch_word_w;
import static mame056.sndintrfH.SOUND_OKIM6295;
import static mame056.sndintrfH.SOUND_YM2151;
import static mame056.sndintrfH.SOUND_YM2203;
import static mame056.sound._2151intf.YM2151_data_port_0_w;
import static mame056.sound._2151intf.YM2151_register_port_0_w;
import static mame056.sound._2151intf.YM2151_status_port_0_r;
import static mame056.sound._2151intfH.YM3012_VOL;
import static mame056.sound._2203intf.YM2203_control_port_0_w;
import static mame056.sound._2203intf.YM2203_control_port_1_w;
import static mame056.sound._2203intf.YM2203_read_port_0_r;
import static mame056.sound._2203intf.YM2203_read_port_1_r;
import static mame056.sound._2203intf.YM2203_status_port_0_r;
import static mame056.sound._2203intf.YM2203_status_port_1_r;
import static mame056.sound._2203intf.YM2203_write_port_0_w;
import static mame056.sound._2203intf.YM2203_write_port_1_w;
import static mame056.sound._2203intfH.YM2203_VOL;
import static mame056.sound.mixerH.MIXER_PAN_CENTER;
import static mame056.sound.oki6295.OKIM6295_data_0_w;
import static mame056.sound.oki6295.OKIM6295_status_0_r;
