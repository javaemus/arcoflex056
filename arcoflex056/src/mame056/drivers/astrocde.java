...
import static WIP.mame056.machine.astrocde.ebases_trackball_r;
import static WIP.mame056.machine.astrocde.ebases_trackball_select_w;
import static WIP.mame056.machine.astrocde.gorf_timer_r;
import static WIP.mame056.machine.astrocde.seawolf2_controller1_r;
import static WIP.mame056.machine.astrocde.seawolf2_controller2_r;
import static WIP.mame056.sndhrdw.astrocde.wow_port_2_r;
import static WIP.mame056.sndhrdw.astrocde.wow_sample_names;
import static WIP.mame056.sndhrdw.astrocde.wow_sh_start;
import static WIP.mame056.sndhrdw.astrocde.wow_sh_update;
import static WIP.mame056.sndhrdw.astrocde.wow_speech_r;
import static WIP.mame056.sndhrdw.gorf.gorf_port_2_r;
import static WIP.mame056.sndhrdw.gorf.gorf_sample_names;
import static WIP.mame056.sndhrdw.gorf.gorf_sh_start;
import static WIP.mame056.sndhrdw.gorf.gorf_sh_update;
import static WIP.mame056.sndhrdw.gorf.gorf_speech_r;
import static WIP.mame056.sound.astrocde.astrocade_sound1_w;
import static WIP.mame056.sound.astrocde.astrocade_sound2_w;
...
import static WIP.mame056.vidhrdw.astrocde.astrocde_colour_block_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_colour_register_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_colour_split_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_init_palette;
import static WIP.mame056.vidhrdw.astrocde.astrocde_interrupt_enable_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_interrupt_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_magic_control_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_magic_expand_color_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_mode_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_pattern_board_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_stars_vh_start;
import static WIP.mame056.vidhrdw.astrocde.astrocde_vertical_blank_w;
import static WIP.mame056.vidhrdw.astrocde.astrocde_vh_screenrefresh;
import static WIP.mame056.vidhrdw.astrocde.astrocde_vh_start;
import static WIP.mame056.vidhrdw.astrocde.astrocde_vh_stop;
import static WIP.mame056.vidhrdw.astrocde.gorf_interrupt;
import static WIP.mame056.vidhrdw.astrocde.gorf_io_r;
import static WIP.mame056.vidhrdw.astrocde.seawolf2_vh_screenrefresh;
import static WIP.mame056.vidhrdw.astrocde.wow_intercept_r;
import static WIP.mame056.vidhrdw.astrocde.wow_interrupt;
import static WIP.mame056.vidhrdw.astrocde.wow_io_r;
import static WIP.mame056.vidhrdw.astrocde.wow_magicram_w;
import static WIP.mame056.vidhrdw.astrocde.wow_video_retrace_r;
import static WIP.mame056.vidhrdw.astrocde.wow_videoram;
import static WIP.mame056.vidhrdw.astrocde.wow_videoram_w;
...
import static mame056.inptportH.IPF_CENTER;
...
import static mame056.inptportH.IPT_PADDLE;
...
import static mame056.memory.install_port_read_handler;
import static mame056.memory.install_port_write_handler;
...
import static mame056.sndintrfH.SOUND_ASTROCADE;
