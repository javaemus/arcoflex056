...
public class xevious
{
	...
	public static UBytePtr rom2a = new UBytePtr();
	public static UBytePtr rom2b = new UBytePtr();
	public static UBytePtr rom2c = new UBytePtr();
...
/*TODO*///	logerror("%04x: custom IO offset %02x data %02x\n",cpu_get_pc(),offset,data);
		...
		switch (customio_command)
		{
			...
			case 0x68:
				if (offset == 6)
				{
					...
					/* We just use samples. */
                                        char[] ch1 ={0x40, 0x40, 0x40, 0x01, 0xff, 0x00, 0x20};
                                        char[] ch2 ={0x30, 0x40, 0x00, 0x02, 0xdf, 0x00, 0x10};
                                        char[] ch3 ={0x30, 0x10, 0x00, 0x80, 0xff, 0x00, 0x10};
                                        char[] ch4 ={0x30, 0x80, 0x80, 0x01, 0xff, 0x00, 0x10};
                                        
					if (memcmp(customio,ch1,7) == 0)
					{
						sample_start (0, 0, 0);
					}
					else if (memcmp(customio,ch2,7) == 0)
					{
						sample_start (0, 1, 0);
					}
					else if (memcmp(customio,ch3,7) == 0)
					{
						sample_start (0, 2, 0);
					}
					else if (memcmp(customio,ch4,7) == 0)
					{
						sample_start (0, 3, 0);
					}
					else
