...
public class ttmahjng
{
	...
	public static UBytePtr ttmahjng_color_prom = new UBytePtr();
	...
	***************************************************************************/
	public static VhUpdatePtr ttmahjng_vh_screenrefresh = new VhUpdatePtr() { public void handler(mame_bitmap bitmap,int full_refresh) 
	{
		...
		copybitmap(bitmap,tmpbitmap2,0,0,0,0,new rectangle(Machine.visible_area),TRANSPARENCY_NONE,0);
		copybitmap(bitmap,tmpbitmap1,0,0,0,0,new rectangle(Machine.visible_area),TRANSPARENCY_COLOR,0);
	} };
