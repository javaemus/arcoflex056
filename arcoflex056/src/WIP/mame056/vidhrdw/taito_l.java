...
import static WIP.mame056.drivers.taito_l.taitol_rambanks;
...
public class taito_l
{
	...
	static int SPRITERAM_SIZE = 0x400;
	...
	***************************************************************************/
	...
	static GetTileInfoPtr get_bg18_tile_info = new GetTileInfoPtr() {
	...
	static GetTileInfoPtr get_bg19_tile_info = new GetTileInfoPtr() {
            public void handler(int tile_index) {
	...
	static GetTileInfoPtr get_ch1a_tile_info = new GetTileInfoPtr() {
            public void handler(int tile_index) {
	...
	***************************************************************************/
	...
	//	logerror("Control Read %02x (%04x)\n", cur_ctrl, cpu_get_pc());
        ...
        public static abstract interface taitol_HandlerPtr {
            public abstract void handler(int offset);
        }
	
	public static taitol_HandlerPtr taitol_chardef14_m = new taitol_HandlerPtr() {
	...
	public static taitol_HandlerPtr taitol_chardef15_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef16_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef17_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef1c_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef1d_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef1e_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_chardef1f_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
	...
	public static taitol_HandlerPtr taitol_bg18_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
		tilemap_mark_tile_dirty(bg18_tilemap,offset/2);
            }
        };
	
	public static taitol_HandlerPtr taitol_bg19_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
		tilemap_mark_tile_dirty(bg19_tilemap,offset/2);
            }
        };
	
	public static taitol_HandlerPtr taitol_char1a_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
		tilemap_mark_tile_dirty(ch1a_tilemap,offset/2);
            }
        };
	
	public static taitol_HandlerPtr taitol_obj1b_m = new taitol_HandlerPtr() {
            public void handler(int offset) {
/*TODO*///	#if 0
/*TODO*///		if (offset>=0x3f0 && offset<=0x3ff)
/*TODO*///		{
/*TODO*///			/* scroll, handled in vh-screenrefresh */
/*TODO*///		}
/*TODO*///	#endif
            }
        };
