...
import static WIP.mame056.vidhrdw.pstadium.*;
...
public class pstadium
{
	...
	public static WriteHandlerPtr pstadium_soundbank_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if ((data & 0x80)==0) soundlatch_clear_w.handler(0, 0);
		cpu_setbank(1, new UBytePtr(RAM, 0x08000 + (0x8000 * (data & 0x03))));
	} };
	...
	public static ReadHandlerPtr pstadium_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		data = soundlatch_r.handler(0);
		return data;
	} };
	
	public static InitDriverPtr init_pstadium = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_PSTADIUM;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_triplew1 = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_TRIPLEW1;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_triplew2 = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_TRIPLEW2;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_ntopstar = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_NTOPSTAR;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_mjlstory = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_MJLSTORY;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_vanilla = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_VANILLA;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_finalbny = new InitDriverPtr() { public void handler()
	{
	...
	public static InitDriverPtr init_qmhayaku = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_QMHAYAKU;
		nb1413m3_int_count = 0;
	} };
	
	public static InitDriverPtr init_galkoku = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_GALKOKU;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_hyouban = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_HYOUBAN;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_galkaika = new InitDriverPtr() { public void handler()
	{
	
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
	
		// Patch to IM2 -> IM1
		ROM.write(0x0002, 0x56);
	
		nb1413m3_type = NB1413M3_GALKAIKA;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_tokyogal = new InitDriverPtr() { public void handler()
	{
	...
	public static InitDriverPtr init_tokimbsj = new InitDriverPtr() { public void handler()
	{
	...
	public static InitDriverPtr init_mcontest = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_MCONTEST;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_av2mj1 = new InitDriverPtr() { public void handler()
	{
	...
	public static WriteHandlerPtr io_pstadium_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		switch (offset & 0xff00)
		{
			...
			case	0x8000:	pstadium_sound_w.handler(0, data); break;
...
/*TODO*///	#endif
	...
	public static IO_WritePort sound_writeport_pstadium[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
/*TODO*///	#if SIGNED_DAC
/*TODO*///		new IO_WritePort( 0x00, 0x00, DAC_0_signed_data_w ),
/*TODO*///		new IO_WritePort( 0x02, 0x02, DAC_1_signed_data_w ),
/*TODO*///	#else
...
/*TODO*///	#endif
	...
	static MachineDriver machine_driver_pstadium = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
				6000000/2,		/* 3.00 MHz */ 
				readmem_pstadium, writemem_pstadium, readport_pstadium, writeport_pstadium, 
		...
		/* video hardware */ 
		1024, 512, new rectangle( 0, 638-1, 255, 495-1 ), 
		null, 
		256, 0, 
		null, 
	...
	//NBMJDRV1( triplew1, triplew1, triplew1, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_triplew1 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
				6000000/2,		/* 3.00 MHz */ 
				readmem_triplew1, writemem_triplew1, readport_pstadium, writeport_pstadium, 
				nb1413m3_interrupt, 1 
			), 
			new MachineCPU( 
				CPU_Z80 | CPU_AUDIO_CPU, 
	...
	//NBMJDRV1( triplew2, triplew2, triplew2, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_triplew2 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
				6000000/2,		/* 3.00 MHz */ 
				readmem_triplew2, writemem_triplew2, readport_pstadium, writeport_pstadium, 
				nb1413m3_interrupt, 1 
			), 
			new MachineCPU( 
				CPU_Z80 | CPU_AUDIO_CPU, 
	...
	//NBMJDRV1( ntopstar, pstadium, pstadium, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_ntopstar = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
	...
	//NBMJDRV1( mjlstory, mjlstory, mjlstory, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjlstory = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
				6000000/2,		/* 3.00 MHz */ 
				readmem_mjlstory, writemem_mjlstory, readport_pstadium, writeport_pstadium, 
				nb1413m3_interrupt, 1 
			), 
			new MachineCPU( 
				CPU_Z80 | CPU_AUDIO_CPU, 
	...
	//NBMJDRV1(  vanilla, pstadium, pstadium, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_vanilla = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
	...
	//NBMJDRV1( finalbny, pstadium, pstadium, pstadium, pstadium, nb1413m3_nvram_handler )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_finalbny = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
	...
	//NBMJDRV1( qmhayaku, pstadium, pstadium, pstadium, pstadium, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_qmhayaku = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
	...
	static MachineDriver machine_driver_galkoku = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				(int)(25000000/6.25),		/* 4.00 MHz ? */ 
				readmem_galkoku, writemem_galkoku, readport_galkoku, writeport_galkoku, 
	...
	static MachineDriver machine_driver_hyouban = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				(int)(25000000/6.25),		/* 4.00 MHz ? */ 
				readmem_galkoku, writemem_galkoku, readport_hyouban, writeport_hyouban, 
				nb1413m3_interrupt, 128 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV2( galkaika, galkaika, galkaika,  galkoku,  galkoku, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_galkaika = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				(int)(25000000/6.25),		/* 4.00 MHz ? */ 
				readmem_galkaika, writemem_galkaika, readport_galkoku, writeport_galkoku, 
				nb1413m3_interrupt, 128 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV2( tokyogal, tokyogal, tokyogal,  galkoku,  galkoku, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_tokyogal = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				(int)(25000000/6.25),		/* 4.00 MHz ? */ 
				readmem_tokyogal, writemem_tokyogal, readport_galkoku, writeport_galkoku, 
				nb1413m3_interrupt, 128 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV2( tokimbsj, galkaika, galkaika,  galkoku,  galkoku, nb1413m3_nvram_handler )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_tokimbsj = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV2( mcontest,  galkoku,  galkoku,  galkoku,  galkoku, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mcontest = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
        ...
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_av2mj1 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80, 
				6000000/2,		/* 3.00 MHz */ 
				readmem_av2mj1, writemem_av2mj1, readport_pstadium, writeport_av2mj1, 
				nb1413m3_interrupt, 1 
			), 
			new MachineCPU( 
				CPU_Z80 | CPU_AUDIO_CPU, 
