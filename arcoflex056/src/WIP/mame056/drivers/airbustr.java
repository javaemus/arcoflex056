...
import static WIP.mame056.vidhrdw.airbustr.*;
...
public class airbustr
{
	...
	public static UBytePtr devram = new UBytePtr(), sharedram = new UBytePtr();
	public static int soundlatch_status, soundlatch2_status;
	
	/* Debug stuff (bound to go away sometime) */
	public static int u1, u2, u3, u4;
	...
	*/
	...
	public static ReadHandlerPtr devram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			...
			default:	{ return devram.read(offset); /*break;*/}
		}
	...
	public static WriteHandlerPtr bankswitch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		cpu_setbank(1,RAM);
	//	if (data > 7)	logerror("CPU #0 - suspicious bank: %d ! - PC = %04Xn", data, cpu_get_pc());
	...
	*/
	...
	public static WriteHandlerPtr bankswitch2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		cpu_setbank(2,RAM);
	//	if (data > 7)	logerror("CPU #1 - suspicious bank: %d ! - PC = %04Xn", data, cpu_get_pc());
	...
	*/
	...
	public static WriteHandlerPtr sound_bankswitch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		cpu_setbank(3,RAM);
	//	if (data > 7)	logerror("CPU #2 - suspicious bank: %d ! - PC = %04Xn", data, cpu_get_pc());
	...
	*/
	...
	(
		1,
		new int[]{ 12000000/4/165 }, /* 3MHz -> 6295 (mode A) */
