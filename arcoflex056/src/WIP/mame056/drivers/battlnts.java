...
import static WIP.mame056.vidhrdw.battlnts.*;
...
public class battlnts
{
	...
	*/
	static void shuffle(UBytePtr buf,int len)
	{
		...
		if ((len % 4)!=0) 
                    System.out.println("ERROR /* must not happen */"); //exit(1);	/* must not happen */
	...
	public static InitDriverPtr init_rackemup = new InitDriverPtr() { public void handler()
	{
		/* rearrange char ROM */
