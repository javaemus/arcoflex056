...
import static WIP.mame056.vidhrdw.mainevt.*;
...
/*TODO*///		set_led_status(2,data & 0x04);
/*TODO*///		set_led_status(3,data & 0x08);
	} };
	...
	//logerror("CPU #1 PC: %04x bank switch = %02x\n",cpu_get_pc(),data);
		...
		src = new UBytePtr(memory_region(REGION_SOUND2), 0x20000);
		dest = new UBytePtr(memory_region(REGION_SOUND2));
		memcpy(dest, new UBytePtr(src, ((data >> 4) & 0x03) * 0x20000),0x20000);
	} };
