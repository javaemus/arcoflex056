...
import static WIP.mame056.vidhrdw.gionbana.*;
...
public class gionbana
{
	...
	public static InitDriverPtr init_gionbana = new InitDriverPtr() { public void handler()
	{
/*TODO*///	#if 1
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
	
		// Protection ROM check skip
		ROM.write(0x00e4, 0x00);
		ROM.write(0x00e5, 0x00);
		ROM.write(0x00e6, 0x00);
	
		// ROM(program) check skip
		ROM.write(0x021a, 0x00);
		ROM.write(0x021b, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_GIONBANA;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_hanamomo = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_HANAMOMO;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_msjiken = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_MSJIKEN;
		nb1413m3_int_count = 144;
	} };
	
	public static InitDriverPtr init_telmahjn = new InitDriverPtr() { public void handler()
	{
/*TODO*///	#if 1
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
	
		// Protection ROM check skip
		ROM.write(0x0133, 0x00);
		ROM.write(0x0134, 0x00);
		ROM.write(0x0135, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_TELMAHJN;
		nb1413m3_int_count = 144;
	} };
	
	public static InitDriverPtr init_mgmen89 = new InitDriverPtr() { public void handler()
	{
/*TODO*///	#if 1
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
	
		// Protection ROM check skip
		ROM.write(0x0144, 0x00);
		ROM.write(0x0145, 0x00);
		ROM.write(0x0146, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_MGMEN89;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_mjfocus = new InitDriverPtr() { public void handler()
	{
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
		int i;
	
		for (i = 0xf800; i < 0x10000; i++) ROM.write(i, 0x00);
/*TODO*///	#if 1
		// Protection ROM check skip
		ROM.write(0x0134, 0x00);
		ROM.write(0x0135, 0x00);
		ROM.write(0x0136, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_MJFOCUS;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_mjfocusm = new InitDriverPtr() { public void handler()
	{
/*TODO*///	#if 1
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
	
		// Protection ROM check skip
		ROM.write(0x014e, 0x00);
		ROM.write(0x014f, 0x00);
		ROM.write(0x0150, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_MJFOCUSM;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_peepshow = new InitDriverPtr() { public void handler()
	{
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
		int i;
...
/*TODO*///	#if 1
		// Protection ROM check skip
		ROM.write(0x010f, 0x00);
		ROM.write(0x0110, 0x00);
		ROM.write(0x0111, 0x00);
/*TODO*///	#endif
		nb1413m3_type = NB1413M3_PEEPSHOW;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_scandal = new InitDriverPtr() { public void handler()
	{
		UBytePtr ROM = new UBytePtr(memory_region(REGION_CPU1));
		int i;
	...
	public static InitDriverPtr init_scandalm = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_SCANDALM;
		nb1413m3_int_count = 128;
	} };
	
	public static InitDriverPtr init_mjnanpas = new InitDriverPtr() { public void handler()
	{
/*TODO*///	#if 0
/*TODO*///		unsigned char *ROM = memory_region(REGION_CPU1);
/*TODO*///	
/*TODO*///		// Protection ROM check skip (not used)
/*TODO*///		ROM[0x0000] = 0x00;
/*TODO*///		ROM[0x0000] = 0x00;
/*TODO*///		ROM[0x0000] = 0x00;
/*TODO*///	#endif
	...
	public static InitDriverPtr init_bananadr = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_BANANADR;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_club90s = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_CLUB90S;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_mladyhtr = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_MLADYHTR;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_chinmoku = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_CHINMOKU;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_maiko = new InitDriverPtr() { public void handler()
	{
		nb1413m3_type = NB1413M3_MAIKO;
		nb1413m3_int_count = 132;
	} };
	
	public static InitDriverPtr init_hanaoji = new InitDriverPtr() { public void handler()
	{
	...
	public static WriteHandlerPtr io_gionbana_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		switch (offset & 0xff00)
		{
			...
			case	0xc000:	break;
/*TODO*///	#if SIGNED_DAC
/*TODO*///			case	0xd000:	DAC_0_signed_data_w(0, data); break;
/*TODO*///	#else
...
/*TODO*///	#endif
	...
	public static WriteHandlerPtr io_scandal_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			gionbana_paltbl_w.handler(((offset & 0x0f00) >> 8), data);
			return;
		}
...
/*TODO*///	#endif
	...
	static MachineDriver machine_driver_gionbana = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_gionbana, writemem_gionbana, readport_gionbana, writeport_gionbana, 
				nb1413m3_interrupt, 132 
                        ) 
		}, 
		...
		/* video hardware */ 
		512, 256, new rectangle( 0, 512-1, 7, 247-1 ), 
		null, 
		256, 0, 
		null, 
	...
	static MachineDriver machine_driver_hanamomo = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_hanamomo, writemem_hanamomo, readport_gionbana, writeport_hanamomo, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV2(  msjiken, 144, gionbana, gionbana, gionbana,  msjiken, 0 )
        //#define NBMJDRV2( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_msjiken = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_gionbana, writemem_gionbana, readport_gionbana, writeport_msjiken, 
        ...
        //#define NBMJDRV2( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_scandal = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_scandalm, writemem_scandalm, readport_gionbana, writeport_scandal, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	static MachineDriver machine_driver_telmahjn = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV3(  mgmen89, 132, gionbana, gionbana, gionbana, gionbana, 0 )
        //#define NBMJDRV3( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mgmen89 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU(
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	static MachineDriver machine_driver_mjfocus = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV4( peepshow, 132, gionbana, gionbana, gionbana, gionbana, 0 )
        //#define NBMJDRV4( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_peepshow = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	static MachineDriver machine_driver_mjnanpas = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_club90s, writemem_club90s, readport_gionbana, writeport_gionbana, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV5(  club90s, 132,  club90s,  club90s, gionbana, gionbana, 0 )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_club90s = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV5( mladyhtr, 132,  club90s,  club90s, gionbana, gionbana, 0 )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mladyhtr = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV5( chinmoku, 132,  club90s,  club90s, gionbana, gionbana, 0 )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_chinmoku = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
	...
	//NBMJDRV5(    maiko, 132,    maiko,    maiko,    maiko,    maiko, 0 )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_maiko = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_maiko, writemem_maiko, readport_maiko, writeport_maiko, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV5(  hanaoji, 132,  hanaoji,  hanaoji,    maiko,    maiko, nb1413m3_nvram_handler )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_hanaoji = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_hanaoji, writemem_hanaoji, readport_maiko, writeport_maiko, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	//NBMJDRV5( bananadr, 132, scandalm, scandalm, gionbana, bananadr, nb1413m3_nvram_handler )
        //#define NBMJDRV5( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_bananadr = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_scandalm, writemem_scandalm, readport_gionbana, writeport_bananadr, 
				nb1413m3_interrupt, 132 
			) 
		}, 
		60, DEFAULT_REAL_60HZ_VBLANK_DURATION, 
	...
	static MachineDriver machine_driver_mjfocusm = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
				20000000/4,		/* 5.00 MHz ? */ 
				readmem_scandalm, writemem_scandalm, readport_scandalm, writeport_scandalm, 
	...
	//NBMJDRV6( scandalm, 128, scandalm, scandalm, scandalm, scandalm, nb1413m3_nvram_handler )
        //#define NBMJDRV6( _name_, _intcnt_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_scandalm = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80 | CPU_16BIT_PORT, 
