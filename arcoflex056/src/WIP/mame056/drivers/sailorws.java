...
import static WIP.mame056.vidhrdw.sailorws.*;
...
public class sailorws
{
	...
	public static final int	SIGNED_DAC	= 0;		// 0:unsigned DAC, 1:signed DAC
	...
	static UBytePtr sailorws_nvram = new UBytePtr();
	static int[] sailorws_nvram_size = new int[1];
	
	
	static nvramPtr sailorws_nvram_handler = new nvramPtr() {
            public void handler(Object file, int read_or_write) {
                if (read_or_write != 0)
			osd_fwrite(file, sailorws_nvram, sailorws_nvram_size[0]);
		else
		{
			if (file != null)
				osd_fread(file, sailorws_nvram, sailorws_nvram_size[0]);
			else
				memset(sailorws_nvram, 0, sailorws_nvram_size[0]);
		}
            }
        };
	...
	{
		UBytePtr SNDROM = new UBytePtr(memory_region(REGION_CPU2));
	
		cpu_setbank(1, new UBytePtr(SNDROM, 0x08000 + (0x8000 * (data & 0x03))));
	}
	...
	static int[] pio_dir=new int[5*2], pio_latch=new int[5*2];
	
	static int tmpz84c011_pio_r(int offset)
	{
		int portdata;
	
		if ((strcmp(Machine.gamedrv.name, "mscoutm")==0) ||
		    (strcmp(Machine.gamedrv.name, "imekura")==0) ||
		    (strcmp(Machine.gamedrv.name, "mjegolf")==0))
		{
			switch (offset)
			{
				case	0:			/* PA_0 */
				...
				default:
					logerror("PC %04X: TMPZ84C011_PIO Unknown Port Read %02Xn", cpu_get_pc(), offset);
					portdata = 0xff;
					break;
			}
		}
	...
	{
		if ((strcmp(Machine.gamedrv.name, "imekura")==0) ||
		    (strcmp(Machine.gamedrv.name, "mscoutm")==0) ||
		    (strcmp(Machine.gamedrv.name, "mjegolf")==0))
		{
			switch (offset)
			{
				...
				case	6:			/* PB_1 */
/*TODO*///	#if SIGNED_DAC
/*TODO*///					DAC_1_signed_data_w(0, data);
/*TODO*///	#else
					DAC_1_data_w.handler(0, data);
/*TODO*///	#endif
					break;
				case	7:			/* PC_1 */
/*TODO*///	#if SIGNED_DAC
/*TODO*///					DAC_0_signed_data_w(0, data);
/*TODO*///	#else
					DAC_0_data_w.handler(0, data);
/*TODO*///	#endif
					break;
				case	8:			/* PD_1 */
					break;
				case	9:			/* PE_1 */
					if ((data & 0x01)==0) sailorws_soundclr_w(0, 0);
					break;
	
				default:
					logerror("PC %04X: TMPZ84C011_PIO Unknown Port Write %02X, %02Xn", cpu_get_pc(), offset, data);
					break;
			}
		}
		else
...
/*TODO*///	#endif
	...
	static ReadHandlerPtr ctc0_interrupt = new ReadHandlerPtr() {
	...
	static ReadHandlerPtr ctc1_interrupt = new ReadHandlerPtr() {
            public int handler(int state) {
	...
	static InterruptPtr ctc0_trg1 = new InterruptPtr() {
            public int handler() {
                z80ctc_0_trg1_w.handler(0, 1);
		z80ctc_0_trg1_w.handler(0, 0);
	...
	(
		2,			/* 2 chip */
		new int[]{ 0, 1 },		/* clock */
		new int[]{ 0, 0 },		/* timer disables */
		new ReadHandlerPtr[]{ ctc0_interrupt, ctc1_interrupt },	/* interrupt handler */
		new WriteHandlerPtr[]{ null, z80ctc_1_trg3_w },	/* ZC/TO0 callback ctc1.zc0 . ctc1.trg3 */
		new WriteHandlerPtr[]{ null, null },		/* ZC/TO1 callback */
		new WriteHandlerPtr[]{ null, null }		/* ZC/TO2 callback */
	);
	
	static void tmpz84c011_init()
	{
		int i;
	...
	public static InitMachinePtr sailorws_init_machine = new InitMachinePtr() { public void handler()
	{
		//
	} };
	...
	public static InitDriverPtr init_mjuraden = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_koinomp = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_patimono = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mmehyou = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_gal10ren = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mjlaman = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mkeibaou = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_pachiten = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mjanbari = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_sailorws = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_sailorwr = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_psailor1 = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_psailor2 = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_otatidai = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_ngpgal = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mjgottsu = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_bakuhatu = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_cmehyou = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mjkoiura = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mscoutm = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_imekura = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	public static InitDriverPtr init_mjegolf = new InitDriverPtr() { public void handler() { initialize_driver(); } };
	...
	public static void MJCTRL_SAILORWS_PORT1() {
	...
	public static void MJCTRL_SAILORWS_PORT2() {
	...
	public static void MJCTRL_SAILORWS_PORT3() {
	...
	public static void MJCTRL_SAILORWS_PORT4() {
        ...
        public static void MJCTRL_SAILORWS_PORT5() {
	...
	public static void MJCTRL_MSCOUTM_PORT1() {
		PORT_START(); 	/* (3) PORT 1-0 */ 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );
		PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P1 Kan", KEYCODE_LCONTROL, IP_JOY_NONE );
		PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1 M", KEYCODE_M, IP_JOY_NONE );
	...
	public static void MJCTRL_MSCOUTM_PORT2() {
		PORT_START(); 	/* (4) PORT 1-1 */ 
		PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "P1 Bet", KEYCODE_2, IP_JOY_NONE );
		PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P1 Reach", KEYCODE_LSHIFT, IP_JOY_NONE );
		PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1 N", KEYCODE_N, IP_JOY_NONE );
	...
	public static void MJCTRL_MSCOUTM_PORT3() {
		PORT_START(); 	/* (5) PORT 1-2 */ 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P1 Ron", KEYCODE_Z, IP_JOY_NONE );
		PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1 Chi", KEYCODE_SPACE, IP_JOY_NONE );
	...
	public static void MJCTRL_MSCOUTM_PORT4() {
		PORT_START(); 	/* (6) PORT 1-3 */ 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1 Pon", KEYCODE_LALT, IP_JOY_NONE );
	...
	public static void MJCTRL_MSCOUTM_PORT5() {
		PORT_START(); 	/* (7) PORT 1-4 */ 
		PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "P1 Small", KEYCODE_BACKSPACE, IP_JOY_NONE );
		PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "P1 Big", KEYCODE_ENTER, IP_JOY_NONE );
		PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "P1 Flip", KEYCODE_X, IP_JOY_NONE );
	...
	{
		new Z80_DaisyChain( z80ctc_reset, z80ctc_interrupt, z80ctc_reti, 0 ),	/* device 0 = CTC_0 */
		new Z80_DaisyChain( null, null, null, -1 )		/* end mark */
	};
	
	static Z80_DaisyChain daisy_chain_sound[] =
	{
		new Z80_DaisyChain( z80ctc_reset, z80ctc_interrupt, z80ctc_reti, 1 ),	/* device 0 = CTC_1 */
		new Z80_DaisyChain( null, null, null, -1 )		/* end mark */
	};
	...
	static MachineDriver machine_driver_mjuraden = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_mjuraden, writemem_mjuraden, readport_mjuraden, writeport_mjuraden, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1(  koinomp,  koinomp,  koinomp,  koinomp,  koinomp, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_koinomp = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_koinomp, writemem_koinomp, readport_koinomp, writeport_koinomp, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( patimono, sailorws, sailorws, patimono, patimono, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_patimono = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_patimono, writeport_patimono, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( mjanbari, sailorws, sailorws, patimono, patimono, sailorws_nvram_handler )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjanbari = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
		...
		sailorws_nvram_handler 
	);

	//NBMJDRV1(  mmehyou,  koinomp,  koinomp,  mmehyou,  mmehyou, sailorws_nvram_handler )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mmehyou = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_koinomp, writemem_koinomp, readport_mmehyou, writeport_mmehyou, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( gal10ren, sailorws, sailorws, gal10ren, gal10ren, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_gal10ren = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_gal10ren, writeport_gal10ren, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1(  mjlaman, sailorws, sailorws,  mjlaman,  mjlaman, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjlaman = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_mjlaman, writeport_mjlaman, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( mkeibaou, sailorws, sailorws, mkeibaou, mkeibaou, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mkeibaou = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_mkeibaou, writeport_mkeibaou, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( pachiten, sailorws, sailorws, pachiten, pachiten, sailorws_nvram_handler )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_pachiten = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_pachiten, writeport_pachiten, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( sailorws, sailorws, sailorws, sailorws, sailorws, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_sailorws = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_sailorws, writeport_sailorws, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( sailorwr, sailorws, sailorws, sailorwr, sailorwr, sailorws_nvram_handler )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_sailorwr = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_sailorwr, writeport_sailorwr, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( psailor1, sailorws, sailorws, psailor1, psailor1, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_psailor1 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_psailor1, writeport_psailor1, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( psailor2, sailorws, sailorws, psailor2, psailor2, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_psailor2 = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_psailor2, writeport_psailor2, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV1( otatidai, sailorws, sailorws, otatidai, otatidai, 0 )
        //#define NBMJDRV1( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_otatidai = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_sailorws, writemem_sailorws, readport_otatidai, writeport_otatidai, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	static MachineDriver machine_driver_ngpgal = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_ngpgal, writemem_ngpgal, readport_ngpgal, writeport_ngpgal, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV2( mjgottsu,   ngpgal,   ngpgal, mjgottsu, mjgottsu, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjgottsu = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_ngpgal, writemem_ngpgal, readport_mjgottsu, writeport_mjgottsu, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV2( bakuhatu,   ngpgal,   ngpgal, mjgottsu, mjgottsu, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_bakuhatu = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
	...
	//NBMJDRV2(  cmehyou,   ngpgal,   ngpgal,  cmehyou,  cmehyou, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_cmehyou = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_ngpgal, writemem_ngpgal, readport_cmehyou, writeport_cmehyou, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV2( mjkoiura, mjuraden, mjuraden, mjkoiura, mjkoiura, 0 )
        //#define NBMJDRV2( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjkoiura = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_mjuraden, writemem_mjuraden, readport_mjkoiura, writeport_mjkoiura, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	static MachineDriver machine_driver_mscoutm = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_mscoutm, writemem_mscoutm, readport_mscoutm, writeport_mscoutm, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV3(  imekura,  mjegolf,  mjegolf,  imekura,  imekura, 0 )
        //#define NBMJDRV3( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_imekura = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_mjegolf, writemem_mjegolf, readport_imekura, writeport_imekura, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
	...
	//NBMJDRV3(  mjegolf,  mjegolf,  mjegolf,  mjegolf,  mjegolf, 0 )
        //#define NBMJDRV3( _name_, _mrmem_, _mwmem_, _mrport_, _mwport_, _nvram_ ) 
	static MachineDriver machine_driver_mjegolf = new MachineDriver
	(
		new MachineCPU[] {
			new MachineCPU( 
				CPU_Z80,		/* TMPZ84C011 */ 
			...
			/*	12000000/3,	*/	/* 4.00 MHz */ 
				12000000/2,		/* 6.00 MHz */ 
				readmem_mjegolf, writemem_mjegolf, readport_mjegolf, writeport_mjegolf, 
				ctc0_trg1, 1, /* vblank is connect to ctc triggfer */ 
				null, 0, daisy_chain_main 
			), 
			new MachineCPU( 
