...
import static WIP.mame056.vidhrdw.contra.*;
...
/*TODO*///	#if 0
/*TODO*///		/* bootleg versions use smaller gfx ROMs, but the data is the same */
/*TODO*///		ROM_LOAD( "g-7.rom",      0x00000, 0x10000, 0x57f467d2 );
/*TODO*///		ROM_LOAD( "g-10.rom",     0x10000, 0x10000, 0xe6db9685 );
/*TODO*///		ROM_LOAD( "g-9.rom",      0x20000, 0x10000, 0x875c61de );
/*TODO*///		ROM_LOAD( "g-8.rom",      0x30000, 0x10000, 0x642765d6 );
/*TODO*///		ROM_LOAD( "g-15.rom",     0x40000, 0x10000, 0xdaa2324b );
/*TODO*///		ROM_LOAD( "g-16.rom",     0x50000, 0x10000, 0xe27cc835 );
/*TODO*///		ROM_LOAD( "g-17.rom",     0x60000, 0x10000, 0xce4330b9 );
/*TODO*///		ROM_LOAD( "g-18.rom",     0x70000, 0x10000, 0x1571ce42 );
/*TODO*///		ROM_LOAD( "g-4.rom",      0x80000, 0x10000, 0x2cc7e52c );
/*TODO*///		ROM_LOAD( "g-5.rom",      0x90000, 0x10000, 0xe01a5b9c );
/*TODO*///		ROM_LOAD( "g-6.rom",      0xa0000, 0x10000, 0xaeea6744 );
/*TODO*///		ROM_LOAD( "g-14.rom",     0xb0000, 0x10000, 0xfca77c5a );
/*TODO*///		ROM_LOAD( "g-11.rom",     0xc0000, 0x10000, 0xbd9ba92c );
/*TODO*///		ROM_LOAD( "g-12.rom",     0xd0000, 0x10000, 0xd0be7ec2 );
/*TODO*///		ROM_LOAD( "g-13.rom",     0xe0000, 0x10000, 0x2b513d12 );
/*TODO*///	#endif
