...
import static WIP.mame056.vidhrdw.ninjakid.*;
...
public class ninjakid
{
	...
	*******************************************************************************/
	...
	static int ninjakun_io_a002_ctrl;
	...
	*******************************************************************************/
	...
	public static InitDriverPtr init_ninjakid = new InitDriverPtr() { public void handler()
	{
		/* Save State Stuff */
/*TODO*///		state_save_register_UINT8 ("NK_Main", 0, "ninjakun_io_a002_ctrl", &ninjakun_io_a002_ctrl, 1);
	} };
