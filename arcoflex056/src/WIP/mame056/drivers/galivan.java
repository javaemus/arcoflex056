...
TODO:
- Find out how layers are enableddisabled
...
import static WIP.mame056.vidhrdw.galivan.*;
...
public class galivan
{
	...
	public static void NIHON_JOYSTICK_1() {
		PORT_START();  
        ...
        public static void NIHON_JOYSTICK_2() {
		PORT_START();  
	...
	public static void NIHON_SYSTEM() {
	...
	public static void NIHON_COINAGE_A() {
	...
	public static void NIHON_COINAGE_B() {
	...
	public static void NIHON_COINAGE_B_ALT() {
		PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Coin_B") ); 
	...
	public static void NIHON_BONUS_LIFE() {
	...
	public static void NIHON_LIVES() {
