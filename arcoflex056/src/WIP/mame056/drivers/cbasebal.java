...
import static WIP.mame056.vidhrdw.cbasebal.*;
...
import static WIP.mame056.machine.kabuki.pang_decode;
...
public class cbasebal
{
	...
	{
		if (rambank == 2)
			return cbasebal_textram_r.handler(offset);	/* VRAM */
		else if (rambank == 1)
		{
			if (offset < 0x800)
		...
		{
			return cbasebal_scrollram_r.handler(offset);	/* SCROLL */
		}
	} };
