...
import static WIP.mame056.vidhrdw.cop01.*;
...
public class cop01
{
	...
	public static ReadHandlerPtr cop01_sound_command_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
                ...
                int TIMER_RATE = 12000;	/* total guess */
	...
	/* this just gets some garbage out of the YM3526 */
        static int timer;
	public static ReadHandlerPtr kludge  = new ReadHandlerPtr() { public int handler(int offset) { return timer++; } };
