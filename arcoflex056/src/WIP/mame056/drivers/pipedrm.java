...
public class pipedrm
{
	...
	public static WriteHandlerPtr pipedrm_bankswitch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		*/
		...
		fromance_gfxreg_w.handler(offset, ((data >> 6) & 0x01) | 	/* flipscreen */
	...
	public static InitDriverPtr init_pipedrm = new InitDriverPtr() { public void handler()
	{
		...
		spriteram_size[0] = 0x400;
	} };
	
	
	public static InitDriverPtr init_hatris = new InitDriverPtr() { public void handler()
	{
