...
public class awt_Configurator implements i_platform_configurator {
    ...
    //LCONTROL + RCONTROL ARE THE SAME IN JAVA....       
     ...
     //RALT - LALT ARE THE SAME IN JAVA
        ...
        public i_input_class awt_inputClass = new i_input_class() {
          ...
          //TODO          /*if (keycode == KEY_PAUSE)
           /*         {
            ...
            public WriteHandlerPtr osd_led_w = new WriteHandlerPtr() { public void handler(int led,int on)
            {
