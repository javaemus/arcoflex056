 ...
 * @author chusogar
 */
public class awt_urlDownloadProgress extends javax.swing.JFrame implements i_URLDownloadProgress_class {
    
    /** Creates new form UrlDownloadProgress */
    public awt_urlDownloadProgress() {
        initComponents();
        super.setTitle(settings.system_name + " initialization");
        System.out.println(settings.system_name + " initialization");
